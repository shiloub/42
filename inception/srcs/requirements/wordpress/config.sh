...
wp core install --allow-root --path="$wppath" --url=amontant.42.fr --title="coucou" --admin_name=super --admin_password=$ADMIN_PASS --admin_email=amontant@42.fr --skip-email
